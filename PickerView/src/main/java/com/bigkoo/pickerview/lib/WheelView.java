...
public class WheelView extends View {
    ...
    private final float DEFAULT_TEXT_TARGET_SKEWX = 0.8f;
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            textSize = a.getDimensionPixelSize(R.styleable.pickerview_pickerview_textSize, textSize);
            textOutSize = a.getDimensionPixelSize(R.styleable.pickerview_pickerview_textOutSize, textOutSize);
            lineSpacingMultiplier = a.getFloat(R.styleable.pickerview_pickerview_lineSpacingMultiplier, lineSpacingMultiplier);
            itemsVisible = a.getInteger(R.styleable.pickerview_pickerview_itemsVisible, itemsVisible);
            a.recycle();//回收内存
        }
    ...
    /**
     * 判断间距是否在1.2 - ∞之间,可通过设置该数值增大Item的高度,默认为2倍文字高
     */
    ...
    private void initPaints() {
        ...
        paintCenterText.setTextSize(textOutSize);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!isLoop) {//不循环的情况
            ...
            if (adapter.getItemsCount() > 0 && preCurrentIndex > adapter.getItemsCount() - 1) {//同理上面,自己脑补一下
    ...
    private void reMeasureTextSize(String contentText) {
        ...
        //设置2条横线外面的文字大小
        paintOuterText.setTextSize(size / textSize * textOutSize);
    }
