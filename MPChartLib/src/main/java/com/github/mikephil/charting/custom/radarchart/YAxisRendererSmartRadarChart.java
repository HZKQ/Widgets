...
public class YAxisRendererSmartRadarChart extends YAxisRenderer {
    
    private final SmartRadarChart mChart;
    private final Path mRenderLimitLinesPathBuffer = new Path();
    
    public YAxisRendererSmartRadarChart(ViewPortHandler viewPortHandler, YAxis yAxis, SmartRadarChart chart) {
