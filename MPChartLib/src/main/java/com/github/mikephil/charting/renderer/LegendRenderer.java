...
import com.github.mikephil.charting.custom.piechart.ISmartPieDataSet;
    ...
    public void computeLegend(ChartData<?> data) {
        ...
        if (!mLegend.isLegendCustom()) {
            ...
            for (int i = 0; i < data.getDataSetCount(); i++) {
                ...
                } else if (dataSet instanceof ISmartPieDataSet) {
    
                    ISmartPieDataSet pds = (ISmartPieDataSet) dataSet;
