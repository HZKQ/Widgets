...
/**
 * @author Created by 汪高皖 on 2018/4/16 0016 08:09
 */
public class SmartBarLineChartTouchListener extends ChartTouchListener<SmartBarLineChartBase<? extends BarLineScatterCandleBubbleData<?
     ...
     */
    public SmartBarLineChartTouchListener(SmartBarLineChartBase<? extends BarLineScatterCandleBubbleData<? extends
    ...
    private void performDrag(MotionEvent event, float distanceX, float distanceY) {
        ...
        if (inverted()) {
            ...
            //    distanceY = -distanceY;
            //}
            //FIXME by 汪高皖 时间：2018/4/16 0016 09:01 修改内容：此处默认为HorizontalBarChart
            distanceX = -distanceX;
        }
