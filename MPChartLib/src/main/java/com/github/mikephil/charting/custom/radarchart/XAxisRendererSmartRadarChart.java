...
public class XAxisRendererSmartRadarChart extends XAxisRenderer {
    
    private final SmartRadarChart mChart;
    
    public XAxisRendererSmartRadarChart(ViewPortHandler viewPortHandler, XAxis xAxis, SmartRadarChart chart) {
