...
public abstract class AxisBase extends ComponentBase {
     ...
     * 推荐使用{@link #setAxisLineWidthInPx(float)}
     */
    @Deprecated
     ...
     * @param width px
     */
    public void setAxisLineWidthInPx(float width) {
     ...
     * label.
     * 推荐使用{@link #setGridLineWidthInPx(float)}
     */
    @Deprecated
     ...
     * @param width px
     */
    public void setGridLineWidthInPx(float width) {
