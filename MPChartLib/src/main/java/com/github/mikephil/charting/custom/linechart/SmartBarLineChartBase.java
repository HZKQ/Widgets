...
/**
 * @author Created by 汪高皖 on 2018/4/13 0013 15:58
 */
public class SmartBarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
     ...
     */
    protected SmartYAxis mAxisLeft;
    
    /**
     * the object representing the labels on the right y-axis
     */
    protected SmartYAxis mAxisRight;
    
    protected YAxisRenderer mAxisRendererLeft;
    protected YAxisRenderer mAxisRendererRight;
    
    protected SmartTransformer mLeftAxisTransformer;
    protected SmartTransformer mRightAxisTransformer;
    ...
    public SmartBarLineChartBase(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }
    
    public SmartBarLineChartBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    
    public SmartBarLineChartBase(Context context) {
        super(context);
    }
    ...
    protected void init() {
        ...
        mLeftAxisTransformer = new SmartTransformer(mViewPortHandler);
        mRightAxisTransformer = new SmartTransformer(mViewPortHandler);
        ...
        mChartTouchListener = new SmartBarLineChartTouchListener(this, mViewPortHandler.getMatrixTouch(), 3f);
     ...
     * bottom axis.
     */
    public SmartYAxis getAxisRight() {
        return mAxisRight;
    }
     ...
     */
    public SmartYAxis getAxis(YAxis.AxisDependency axis) {
        if (axis == YAxis.AxisDependency.LEFT)
            return mAxisLeft;
        else
            return mAxisRight;
    ...
    @Override
    public SmartXAxis getXAxis() {
        return (SmartXAxis) mXAxis;
    }
}
