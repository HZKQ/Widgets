 ...
 * 处理雷达图高亮逻辑
 *
 * @author Created by wanggaowan on 3/18/21 1:54 PM
 */
public class SmartRadarHighlighter extends PieRadarHighlighter<SmartRadarChart> {
    
    public SmartRadarHighlighter(SmartRadarChart chart) {
        super(chart);
    }
