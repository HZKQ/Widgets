...
public class BarcodeEncoder {
    ...
    public BitMatrix encode(String contents, int width, int height) throws WriterException {
        try {
            return new QRCodeWriter().encode(contents, BarcodeFormat.QR_CODE, width, height);
    ...
    public Bitmap encodeBitmap(String contents, int width, int height) throws WriterException {
        return createBitmap(encode(contents, width, height));
    }
    
    public Bitmap encodeBitmap(String contents, int width, int height, Map<EncodeHintType, ?> hints) throws WriterException {
